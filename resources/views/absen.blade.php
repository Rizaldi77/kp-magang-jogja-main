            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class="table table-responsive table-bordered table-hover">
                        ...
                        <tbody>
                           @forelse($data_absen as $apprentice)
                                <tr>
                                    <td>{{$apprentice->date_att}}</td>
                                    <td>{{$apprentice->first_timesheet}}</td>
                                    <td>{{$apprentice->last_timesheet}}</td>
                                    <td>{{$apprentice->status_finish}}</td>
                                </tr>
                            @empty
                                <tr>
